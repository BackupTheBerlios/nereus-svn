...
import scenario.bienenstock.scenariomanagement.Konstanten;
...
import scenario.bienenstock.Scenario;
import scenario.bienenstock.agenteninfo.Info;
...
public class Karte extends AbstractEnviroment {
    ...
    private Info konvertiereInfo(Koordinate pos,
        ...
        if (richtungMitteilen && entfernungMitteilen) {
            return new scenario.bienenstock.agenteninfo.Info(richtung,
                                                 entfernung,
                                                 true,
                                                 true);
        } else if (richtungMitteilen) {
            return new scenario.bienenstock.agenteninfo.Info(richtung, 0, true, false);
        } else if (entfernungMitteilen) {
            return new scenario.bienenstock.agenteninfo.Info(0, entfernung, false, true);
        } else {
            return new scenario.bienenstock.agenteninfo.Info(0, 0, false, false);
        }
    }
