/*
 * Dateiname      : KooperativerAgent.java
 * Erzeugt        : 21. Mai 2005
 ...
 * Der Agent ist kooperativ und verwendet Kooperations- und Kommunikatiosstrategien.
 */
public class KooperativerAgent
    ...
    /**
     * falls eine beabsichtigte Aktion tatsächlich ausgeführt wurde, wird erfold.value den Wert true haben.
     */
    ...
    /**
     * beschreibt den internen Zustand des Agenten.
     */
    DesireIntentionPlan modus=new DesireIntentionPlan();
    
    /**
     * Kooperativer Agent für das Szenario Bienenstock.
     * @param bName Name des Agenten
     * @param bHandler Handler für den Agenten
     */
    public KooperativerAgent(String bName, AbstractScenarioHandler bHandler) {
    ...
    /**
     * Kooperativer Agent für das Szenario Bienestock
     * @param bId Id des Bienen-Agenten
     * @param bName Name des Bienen-Agenten
     */
    public KooperativerAgent(Id bId,String bName) {
        super(bId, bName);
        name = bName;
        volksID = 1;
    }
    ...
    /**
     * Eine Sicherheitsabfrage für den Agententenquelcode.
     * @return true, falls der Agent Runnable implementiert.
     */
    ...
    /**
     * setzt den Aktionscode für den Agenten, der
     * dem Ticket für die Teilnahme an der nächsten Runde entspricht.
     * @param aktionsCode Aktions-Code
    ...
    /**
     * liefert die Id des Volkes, zu der die Biene gehört.
     * @return Id des Bienenvolkes
     */
    ...
    /**
     * Überprüft das aktuelle Ziel des Agenten und wählt, falls das alte Ziel erreicht wurde, eine neues Ziel aus.
    ...
    public void evaluateGoal(DesireIntentionPlan modus){
        ...
        switch (desire){
            case DesireIntentionPlan.G_FINDEEINEBLUME:{
                ...
                }else if ((altesZiel==null) || (altesZiel.equals(myPosition))){ // || (myPosition.equals(this.posBienenstock))){
     ...
     * @param modus interner Zustand des Agenten als DesireInteionPlan-Typ.
     */
    public void abstactPlanning(DesireIntentionPlan modus){
        ...
        switch (desire){
            ...
            case DesireIntentionPlan.G_BLUMEBEARBEITEN:{
                ...
                if (myPosition.equals(d_Ziel)){ // an der Blume
                    ...
                    }else if (this.neueMitteilungErhalten){
                        String my="false";
    ...
    /**
     * gibt die Kosten an, um von der bestimmten Position zurück zum Bienenstock zu fliegen
     * und dort zu tanken.
     * @return Kosten um zum Bienenstock zurück zu kehren und zu tanken.
     * @param vonPosition Position, von der die Kosten zum Bienenstock berechnter werden.
    ...
    /**
     * Berechnet und setzt den Nutzen einer Blume in Abhängigkeit von ihrer Ausbeute und Enfernung zum Bienenstock.
    ...
    /**
     * Gibt die Daten der Biene in jeder Runde in Textform aus.
    ...
    /**
     * aktualisiert die gespeicherten Felder mit den lokalen aktuellen Daten
     ...
     * @return Koordinaten-Liste, die nach der Entfernung zur startKoordinate sortiert ist.
     */
