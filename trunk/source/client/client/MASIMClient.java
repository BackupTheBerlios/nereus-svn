...
public class MASIMClient extends JFrame {
	 ...
	 */
  	private void jbInit() throws Exception  {
		...
		this.setSize(new Dimension(1054, 700));
		...
		m_openGamesTable.setMinimumSize(new Dimension(454, 440));
		m_openGamesTable.setPreferredSize(new Dimension(454, 440));
		...
		m_openGamesScrollPane.getViewport().add(m_openGamesTable, null);
		...
		m_bottomPanel.setMaximumSize(new Dimension(1054, 250));
		m_bottomPanel.setMinimumSize(new Dimension(1054, 250));
		m_bottomPanel.setPreferredSize(new Dimension(1054,250));		
	...
	private DataTableModel createDataModelForOpenGameTable(boolean value) {
		...
		try {
			...
			retval.addHeader("max. Anzahl A.");
			retval.addHeader("akt. Anzahl A.");
			if(tmp != null) {
